...
T _txs = (9.00000/(1.00000+exp(-_rt1))+0.500000);
T _xtofinf = _xtosinf;
T _rt4 = ((-_v/30.0000)*_v)/30.0000;
T _txf =  3.50000*exp(_rt4)+1.50000;
...
T _po = (((((1.00000-xi1ca)-xi2ca)-xi1ba)-xi2ba)-c1) - c2;
...
T _tys = 3000.00/(1.00000+exp(_rt3))+30.0000;
T _ytofinf = _ytosinf;
T _rt5 = (_v+33.5000)/10.0000;
T _tyf = 20.0000/(1.00000+exp(_rt5))+20.0000;
...
T _xik1 = _gkix*pow(({ko_}/5.40000), 1.0/2)*_xkin*(_v-_ek);
T _rsinf = 1.00000/(1.00000+exp(_rt2));
T _xitos = _gtos*xtos*(ytos+0.500000*_rsinf)*(_v-_ek);
T _xitof = _gtof*xtof*ytof*(_v-_ek);
T _xito = _xitos+_xitof;
T _xica =  2.00000*{wca_}*_jca;
T _rg = 1.00000/(1.00000+exp((_v+33.0000)/22.4000));
T _xikr = _gkr*pow(({ko_}/5.40000), 1.0/2)*xr*_rg*(_v-_ek);
T _gksx = 1.00000+0.800000/(1.00000+pow(0.500000/cai, 3.00000));
T _xiks = _gks*_gksx*xs1*xs2*(_v-_eks);
...
T _dc2 = (_beta*c1+_k5*xi2ca+_k5t*xi2ba) - (_k6+_k6t+_alpha)*c2;
T _dxi2ca = (_k3*xi1ca+_k6*c2) - (_k5+_k4)*xi2ca;
T _dxi2ba = (_k3t*xi1ba+_k6t*c2) - (_k5t+_k4t)*xi2ba;
T _dc1 = (_alpha*c2+{k2_}*xi1ca+{k2t_}*xi1ba+{r2_}*_po) - (_beta+{r1_}+{k1t_}+_k1)*c1;
T _dxi1ca = (_k1*c1+_k4*xi2ca+_s1*_po) - (_k3+{k2_}+_s2)*xi1ca;
T _dxi1ba = ( {k1t_}*c1+ _k4t*xi2ba+ {s1t_}*_po) - (_k3t+{k2t_}+{s2t_})*xi1ba;
