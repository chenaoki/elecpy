...
double _gtos = {gtos_} * pow({Q10TO_}, (temp-{temp_})/10.0)*c_brugada;
double _gtof = {gtof_} * pow({Q10TO_}, (temp-{temp_})/10.0)*c_brugada;
double _gNaCa = {gNaCa_} * pow({Q10NACA_}, (temp-{temp_})/10.0);
double _gca = {gca_} * pow({Q10CAL_}, (temp-{temp_})/10.0)/c_brugada;
...
double _dh = (_ah*(1.00000-h) - _bh*h)*c_brugada;
double _dj = (_aj*(1.00000-j) - _bj*j)*c_brugada;
