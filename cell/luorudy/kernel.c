...
_dt = dt;
_m = sw_it*_m + (sw_it == 0)*{m_};
_h = sw_it*_h + (sw_it == 0)*{h_};
_j = sw_it*_j + (sw_it == 0)*{j_};
_ltypeCzero = sw_it*_ltypeCzero + (sw_it == 0)*{ltypeCzero_};
_ltypeCone = sw_it*_ltypeCone + (sw_it == 0)*{ltypeCone_};
_ltypeCtwo = sw_it*_ltypeCtwo + (sw_it == 0)*{ltypeCtwo_};
_ltypeCthree = sw_it*_ltypeCthree + (sw_it == 0)*{ltypeCthree_};
_ltypeIVf = sw_it*_ltypeIVf + (sw_it == 0)*{ltypeIVf_};
_ltypeIVs = sw_it*_ltypeIVs + (sw_it == 0)*{ltypeIVs_};
_ltypeO = sw_it*_ltypeO + (sw_it == 0)*{ltypeO_};
_caiss = sw_it*_caiss + (sw_it == 0)*{caiss_};
_ilca = sw_it*_ilca + (sw_it == 0)*{ilca_};
_inacass = sw_it*_inacass + (sw_it == 0)*{inacass_};
_irel = sw_it*_irel + (sw_it == 0)*{irel_};
_naiss = sw_it*_naiss + (sw_it == 0)*{naiss_};
_ilcana = sw_it*_ilcana + (sw_it == 0)*{ilcana_};
_kiss = sw_it*_kiss + (sw_it == 0)*{kiss_};
_ki = sw_it*_ki + (sw_it == 0)*{ki_};
_ilcak = sw_it*_ilcak + (sw_it == 0)*{ilcak_};
_cai = sw_it*_cai + (sw_it == 0)*{cai_};
_fcasc = sw_it*_fcasc + (sw_it == 0)*{fcasc_};
_fmode0 = sw_it*_fmode0 + (sw_it == 0)*{fmode0_};
_b = sw_it*_b + (sw_it == 0)*{b_};
_g = sw_it*_g + (sw_it == 0)*{g_};
_xr = sw_it*_xr + (sw_it == 0)*{xr_};
...
_ryrCtwo = sw_it*_ryrCtwo + (sw_it == 0)*{ryrCtwo_};
_ryrCthree = sw_it*_ryrCthree + (sw_it == 0)*{ryrCthree_};
_ryrCfour = sw_it*_ryrCfour + (sw_it == 0)*{ryrCfour_};
_ryrOone = sw_it*_ryrOone + (sw_it == 0)*{ryrOone_};
_ryrIone = sw_it*_ryrIone + (sw_it == 0)*{ryrIone_};
_ryrItwo = sw_it*_ryrItwo + (sw_it == 0)*{ryrItwo_};
_ryrIthree = sw_it*_ryrIthree + (sw_it == 0)*{ryrIthree_};
_ryrIfour = sw_it*_ryrIfour + (sw_it == 0)*{ryrIfour_};
_ryrIfive = sw_it*_ryrIfive + (sw_it == 0)*{ryrIfive_};
_csqn = sw_it*_csqn + (sw_it == 0)*{csqn_};
_sponrel = sw_it*_sponrel + (sw_it == 0)*{sponrel_};
_jsr = sw_it*_jsr + (sw_it == 0)*{jsr_};
_it = sw_it*_it + (sw_it == 0)*{it_};
