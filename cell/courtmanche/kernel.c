...
// comp_ina
double _gna = 7.8*APD_change_gna;
...
_h = _ah/(_ah+_bh)-((_ah/(_ah+_bh))-h)*exp(-dt/(1/(_ah+_bh)))*APD_change_h;
_j = _aj/(_aj+_bj)-((_aj/(_aj+_bj))-j)*exp(-dt/(1/(_aj+_bj)))*APD_change_j;
_m = _am/(_am+_bm)-((_am/(_am+_bm))-m)*exp(-dt/(1/(_am+_bm)))*APD_change_m;
...
double _ilca = _d*_f*_fca*_ibarca*APD_change_ilca;
...
double _stretch_it = _v * (-1.09+1.24*exp(0.1/thickness/1.0328)) * 1.0e-3;
_it = sw_it*(st+_naiont+_kiont+_caiont+_stretch_it);
...
_it=_it;
_fibro=fibro;
_APD_change_gna=APD_change_gna;
_APD_change_h=APD_change_h;
_APD_change_m=APD_change_m;
_APD_change_j=APD_change_j;
_APD_change_inak=APD_change_inak;
_APD_change_inab=APD_change_inab;
