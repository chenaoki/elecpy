...
maskPosi =  ( _v < (-30.0+0.00001) ) * 1;
maskPosi *= ( _v >= -30.0 ) * 1;
maskNega = ( maskPosi == 0 ) * 1;
_v = maskPosi * (-30.0+0.00001)+ maskNega * _v;
maskPosi =  ( _v > (-30.0 -0.00001) ) * 1;
maskPosi *= ( _v <= -30.0 ) * 1;
maskNega = ( maskPosi == 0 ) * 1;
_v = maskPosi * (-30.0-0.00001) + maskNega * _v;
...
INa   *= pow({Q10NA_}, (temp-{temp_})/10.0);
INaL  *= 1.0;
Ito   *= pow({Q10TO_}, (temp-{temp_})/10.0);
ICaL  *= pow({Q10CAL_}, (temp-{temp_})/10.0);
ICaNa *= 1.0;
ICaK  *= 1.0;
IKr   *= pow({Q10KR_}, (temp-{temp_})/10.0);
IKs   *= pow({Q10KS_}, (temp-{temp_})/10.0);
IK1   *= pow({Q10K1_}, (temp-{temp_})/10.0);
INaCa *= pow({Q10NACA_}, (temp-{temp_})/10.0);
INaK  *= pow({Q10NAK_}, (temp-{temp_})/10.0);
INab  *= pow({Q10K1_}, (temp-{temp_})/10.0);
IKb   *= 1.0;
IpCa  *= pow({Q10K1_}, (temp-{temp_})/10.0);
ICab  *= pow({Q10K1_}, (temp-{temp_})/10.0);
